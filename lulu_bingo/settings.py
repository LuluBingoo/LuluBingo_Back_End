...
if ENVIRONMENT == "production":
    ...
    if missing:
        raise ValueError(f"Missing database env vars for production: {', '.join(missing)}")
...
Django settings for lulu_bingo project.
...
SECRET_KEY = 'django-insecure-aaox)x7)3474vc2*1h6%85bdw$4=4dr!^mt*r3s203zr3j*$ua'
