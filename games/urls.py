...
urlpatterns = [
    ...
    path("games/<str:code>/pause", GamePauseView.as_view(), name="game-pause"),
    ...
    path("games/<str:code>/players", GameAddPlayerView.as_view(), name="game-add-player"),
    ...
    path("game/cartellas/check", PublicGameCartellaCheckView.as_view(), name="public-game-cartella-check"),
