...
class Game(models.Model):
    ...
    bonus_contribution_amount = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    bonus_awarded_amount = models.DecimalField(max_digits=12, decimal_places=2, default=0)
    bonus_awarded_cartella_index = models.PositiveIntegerField(null=True, blank=True)
